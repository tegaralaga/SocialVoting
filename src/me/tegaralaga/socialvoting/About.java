...
import me.tegaralaga.socialvoting.fragments.FragmentAbout;
import me.tegaralaga.socialvoting.fragments.FragmentContact;
import me.tegaralaga.socialvoting.fragments.FragmentDeviceInfo;
import me.tegaralaga.socialvoting.utils.Utils;

import java.util.HashMap;

public class About extends SherlockFragmentActivity implements ProgressBarIndeterminateCallback {
	...
	protected void onCreate(Bundle savedInstanceState){
		...
		__tm.addTab(createTab("about","About",R.drawable.light_action_about),FragmentAbout.class,null);
		__tm.addTab(createTab("contact","Contact",R.drawable.light_content_email),FragmentContact.class,null);
		__tm.addTab(createTab("info","Info",R.drawable.light_hardware_phone),FragmentDeviceInfo.class,null);
	...
	private TabSpec createTab(final String tag,final String title,final int icon){
        final View tab = LayoutInflater.from(__th.getContext()).inflate(R.layout.tab_bottom_text_image_inflater, null);
        try {
	        ((TextView)tab.findViewById(R.id.name)).setText(title);
	...
	public static class TabManager implements TabHost.OnTabChangeListener {
        ...
        public TabManager(FragmentActivity activity, TabHost tabHost, int containerId, About landing) {
        	__about = landing;
            __fa = activity;
            __th = tabHost;
